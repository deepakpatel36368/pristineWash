...
//                .anyRequest().permitAll(); // Allow access to all requests
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/wash-and-fold/**").permitAll()
                .antMatchers("/dry-cleaning/**").permitAll()
                .antMatchers("/steam-and-iron/**").permitAll()
                .antMatchers("/stain-removal/**").permitAll()
                .antMatchers("/test/anyone").authenticated()
                .antMatchers("/schedule-call").authenticated()
                .antMatchers("/cart/**").authenticated()
                .antMatchers("/product_by_category/**").permitAll()
